sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.untitledPrototype.controller.MainPage", {
		...
		_onGenericTilePress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("Page2", oBindingContext, fnResolve, "", 0);
		...
		_onGenericTilePress1: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("Callendar", oBindingContext, fnResolve, "", 0);
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_List_Page_0-content-build_simple_Table-1617796402304",
				"groups": ["items"]
			}];
